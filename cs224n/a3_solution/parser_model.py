...
class ParserModel(nn.Module):
    ...
    def __init__(
        ...
        self.embed_to_hidden_weight = nn.Parameter(
            torch.empty(self.embed_size * n_features, hidden_size)
        )
    ...
    def embedding_lookup(self, w):
        ...
        select = torch.index_select(self.embeddings, 0, w.flatten())
        x = select.reshape(w.shape[0], -1)
        ### END YOUR CODE
        return x
