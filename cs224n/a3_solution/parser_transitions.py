...
def minibatch_parse(sentences, model, batch_size):
    ...
    while unfinished_parses:
        unfinished_minibatch = unfinished_parses[:batch_size]
        minibatch_transition = model.predict(unfinished_minibatch)
        for trans, parse in zip(minibatch_transition, unfinished_minibatch):
